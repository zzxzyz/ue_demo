...
本规格说明文档化了 LuaDemo 项目中登录窗口的实现细节。
...
| 资源 | 路径 | 父类 | 用途 |
|------|------|------|------|
| WBP_LoginPanel | `Content/FirstPersonBP/Blueprints/WBP_LoginPanel.uasset` | ULuaUserWidget | 登录面板主界面 |
| WBP_LoginDialog | `Content/FirstPersonBP/Blueprints/WBP_LoginDialog.uasset` | **ULoginWidget** | 登录对话框 |
